...
$to      = 'info@houseclearancejkrs.co.uk';
$subject = 'New Enquiry from houseclearancejkrs.co.uk';
$body    = "Name: $name\nPhone: $phone\nEmail: $email\nPostcode: $postcode\nService: $service\nLocation: $location\n\nMessage:\n$message";
$headers  = "From: info@houseclearancejkrs.co.uk\r\n";
$headers .= "Reply-To: " . ($email ?: 'info@houseclearancejkrs.co.uk') . "\r\n";
$headers .= "X-Mailer: PHP/" . phpversion();

if (mail($to, $subject, $body, $headers, '-finfo@houseclearancejkrs.co.uk')) {
